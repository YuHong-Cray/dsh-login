...
<body>
  <main class="card" aria-busy="false">
    <div class="brand">
      ...
      <div class="name">DeepSeek Harness<small>Web GUI · 统一登录</small></div>
    </div>
  ...
  <footer class="foot">
    DeepSeek Harness<span class="dot">·</span>账号存于数据库 <code style="font-family:ui-monospace,monospace">dsh-login</code> 表
  </footer>
